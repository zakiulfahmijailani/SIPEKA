...
// Nama, kode, semester, SKS, praktikum, PBL, dan peminatan mengikuti "Simulasi SIF1 R2".
...
type CourseInput = Omit<Curriculum2026Course, "tipe_aktivitas" | "keterangan_praktikum" | "keterangan_pbl" | "keterangan_semester"> & {
...
const practicalCourses = new Set([
  "SIF101", "SIF107", "SIF108", "SIF109", "SIF202", "SIF214", "SIF307",
  "SIF311", "SIF404", "SIF408", "SIF409", "SIF505", "SIF902",
])

const pblCourses = new Set([
  "SIF107", "SIF108", "SIF213", "SIF214", "SIF319", "SIF408", "SIF409",
  "SIF503", "SIF505", "SIF913", "SIF910",
])

const course = (input: Omit<CourseInput, "has_praktikum" | "is_pbl">): Curriculum2026Course => {
  ...
  return {
    ...
    is_pbl,
    keterangan_pbl: is_pbl ? (input.keterangan_pbl ?? "PBL") : null,
...
export const CURRICULUM_2026_MATA_KULIAH: Curriculum2026Course[] = [
  ...
  course({ kode: "SIF214", nama_id: "Pemrograman Visual", nama_en: "Visual Programming", sks_teori: 2, sks_praktik: 1, semester_rekomendasi: 2, status: "WAJIB", track: "UMUM" }),
  ...
  course({ kode: "SIF319", nama_id: "Pemrograman Bergerak", nama_en: "Mobile Programming", sks_teori: 3, sks_praktik: 0, semester_rekomendasi: 3, status: "WAJIB", track: "UMUM" }),
  ...
  course({ kode: "SIF408", nama_id: "Pemrograman Berorientasi Objek", nama_en: "Object Oriented Programming", sks_teori: 2, sks_praktik: 1, semester_rekomendasi: 4, status: "WAJIB", track: "UMUM" }),
  course({ kode: "SIF409", nama_id: "Analisis dan Perancangan Sistem Informasi", nama_en: "Information System Analysis and Design", sks_teori: 2, sks_praktik: 1, semester_rekomendasi: 4, status: "WAJIB", track: "UMUM" }),
  ...
  course({ kode: "SIF503", nama_id: "Testing dan Implementasi Sistem Informasi", nama_en: "IS Testing and Implementation", sks_teori: 3, sks_praktik: 0, semester_rekomendasi: 5, status: "WAJIB", track: "UMUM", keterangan_pbl: "PBL w. Mobile" }),
  ...
  course({ kode: "SIF505", nama_id: "Manajemen Proyek Sistem Informasi", nama_en: "IS Project Management", sks_teori: 2, sks_praktik: 1, semester_rekomendasi: 5, status: "WAJIB", track: "UMUM", keterangan_pbl: "PBL w. Mobile-Testing" }),
  ...
  course({ kode: "SIF913", nama_id: "Kecerdasan Bisnis", nama_en: "Business Intelligence", sks_teori: 3, sks_praktik: 0, semester_rekomendasi: 5, status: "PILIHAN", track: "DMS", keterangan_pbl: "PBL w. Mobile-Testing-Manajemen Proyek" }),
...
export const CURRICULUM_2026_OFFICIAL_SKS_BY_SEMESTER: Record<number, number> = {
  1: 18,
  2: 20,
  3: 21,
  4: 20,
...
export const CURRICULUM_2026_TOTAL_SKS = Object.values(
  CURRICULUM_2026_OFFICIAL_SKS_BY_SEMESTER
