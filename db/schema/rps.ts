...
export const rps = pgTable("rps", {
  ...
  sasaran_kompetensi_lulusan: text("sasaran_kompetensi_lulusan"),
  metode_pembelajaran: text("metode_pembelajaran"),
  persyaratan_kehadiran: text("persyaratan_kehadiran"),
  perlengkapan_pembelajaran: text("perlengkapan_pembelajaran"),
  status_revisi: text("status_revisi").notNull().default("R-1"),
  tanggal_penyusunan: date("tanggal_penyusunan"),
  nama_penyusun: text("nama_penyusun"),
  jabatan_penyusun: text("jabatan_penyusun").default("Dosen Pengampu"),
  ttd_penyusun: text("ttd_penyusun"),
  ...
  ttd_pengesah: text("ttd_pengesah"),
  dosen_pengampu_tambahan: text("dosen_pengampu_tambahan"),
  created_at: timestamp("created_at").defaultNow().notNull(),
  updated_at: timestamp("updated_at").defaultNow().notNull(),
...
export const rpsPertemuan = pgTable("rps_pertemuan", {
  ...
  tipe: text("tipe").notNull().default("PERTEMUAN"),
...
export const komponenPenilaian = pgTable("komponen_penilaian", {
  ...
  nama: text("nama").notNull(),
  tipe: text("tipe").notNull(),
  kategori_resmi: text("kategori_resmi"),
  bobot: real("bobot").notNull(),
